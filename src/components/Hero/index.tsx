...
const styles = {
  ...
  codeContainer: `relative w-full max-w-lg bg-white/90 dark:bg-gray-800/90 rounded-lg shadow-xl p-8 backdrop-blur-sm border border-gray-200 dark:border-gray-700`, // Increased max-w-md to max-w-lg, p-6 to p-8
  ...
  return (
    <section id="home" className={styles.heroSection}>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        ...
        <div className={`${styles.square} top-1/5 right-1/5 animate-pulse`} style={{ animationDuration: '6s' }}></div>
        <div className={`${styles.triangle} bottom-1/5 right-1/8 animate-bounce`} style={{ animationDuration: '5s' }}></div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12"> {/* Added gap-12 */}
          <div className="w-full md:w-1/2 mb-16 md:mb-0"> {/* Increased mb-12 to mb-16 */}
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mb-10 leading-relaxed"> {/* Increased mb-8 to mb-10 */}
              Making clean code and useful apps with Python and JavaScript.
            </p>
